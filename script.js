...
const scenes = {
    start: {
        ...
        choices: [
            ...
            { text: 'Credits', nextScene: 'Credits'}
        ]
    },
    Credits: {
        text: 'Credits to these people :)',
        video: 'images/Credits.mp4',
        choices: [
            {text: 'Continue with the game', nextScene: 'start1'}
        ]
    },
        start1: {
        ...
        A1v2: {
            text: `Click the different variations of no 27 times for a suprise! or say no and continue with the story`,
            choices: [
                            ...
                            Fight1: {
                                ...
                                Fight8: {
                                    ...
                                    Victory: {
                                        ...
                                        choices: [
                                                { text: 'Celebrate your victory', nextScene: "Choice8a1" }
                                ]
                            },
                                        Choice8a1: {
                                            text: 'As you beat the kid up you also explain the risks of messing up the biogas digester',
                                            choices: [
                                                { text: 'Continue on your way', nextScene:'Choice8v2'}
                                            ]
                                        },
                                    JailEnding: {
    ...
    Choice15: {
        ...
        choices: [
                ...
                Choice16_Ending2: {
                    ...
                    choices: [
                        {text: 'Start over', nextScene: 'AltChoice1'},
                    ]
                },
                Choice16_Ending3: {
                    ...
                    AltChoice1: {
                        text: 'You thought you could start over did you?',
                        choices: [
                        {text: 'Start over', nextScene: 'AltChoice2'},
                        ]
                    },
                    AltChoice2: {
                        text: 'You can no longer break the balance that I placed in',
                        choices: [
                        {text: 'Start over', nextScene: 'AltChoice3'},
                        ]
                    },
                    AltChoice3: {
                        text: 'Your "Start over" button no longer works',
                        choices: [
                        {text: 'Start over', nextScene: 'AltChoice4'},
                        ]
                    },
                    AltChoice4: {
                        text: 'IT IS I SVEN THE EVIL DICTATOR THE FORMER DISCIPLE OF SIR ARONG ANSWER MY QUESTION AND YOU SHALL BE FREE',
                        background: 'images/Sven.jpg',
                        choices: [
                        {text: 'Fight him!', nextScene: 'AltChoice5'},
                        ]
                    },
                                ALTENDING: {
                                    text: 'WRONG! You fool',
                    ...
                    AltChoice5: {
                        text: "You're on the ground, the button is 10m away and 1m off the ground. You can throw at 15m/s. What angle do you need to throw at?",
                        background: 'images/Sven.jpg',
                        choices: [
                        {text: '19 degrees', nextScene: 'AltChoice6'},
                        {text: '18 degrees', nextScene: 'ALTENDING'},
                        {text: '20 degrees', nextScene: 'ALTENDING'},
                        {text: '17 degrees', nextScene: 'ALTENDING'}
                        ]
                    },
                    AltChoice6: {
                        text: 'What do you put on a biogas digester?',
                        background: 'images/Sven.jpg',
                        choices: [
                        {text: 'Plastic bags', nextScene: 'ALTENDING'},
                        {text: 'Old phones', nextScene: 'ALTENDING'},
                        {text: 'Kitchen waste', nextScene: 'AltChoices7'},
                        {text: 'Metals', nextScene: 'ALTENDING'},
                        ]
                    },
                    AltChoices7: {
                        text: 'What tool do you use in making the digester?',
                        background: 'images/Sven.jpg',
                        choices: [
                        {text: 'Sledgehammer', nextScene: 'ALTENDING'},
                        {text: 'Drill', nextScene: 'AltChoices8'},
                        {text: 'Pickaxe', nextScene: 'ALTENDING'},
                        {text: 'Gun', nextScene: 'ALTENDING'},
                        ]
                    },
                    AltChoices8: {
                        text: 'What do you test your biogas digester with first?',
                        background: 'images/Sven.jpg',
                        choices: [
                        {text: 'Charging your phone', nextScene: 'ALTENDING'},
                        {text: 'Flying an airplane', nextScene: 'ALTENDING'},
                        {text: 'Cooking', nextScene: 'AltChoices9'},
                        {text: 'Money farming', nextScene: 'ALTENDING'},
                        ]
                    },
                    AltChoices9: {
                        text: 'Should you use your biogas digester every day?',
                        background: 'images/Sven.jpg',
                        choices: [
                        {text: 'Yes, because it helps reduce pollution.', nextScene: 'ALTENDING'},
                        {text: 'Yes, because it is always safe to have around.', nextScene: 'ALTENDING'},
                        {text: 'No, because it is inferior to things we have.', nextScene: 'ALTENDING'},
                        {text: 'No, because there are a few risks when used too much.', nextScene: 'AltChoices10'},
                        ]
                    },
                    AltChoices10: {
                        text: 'FINAL QUESTION... As Sir Arongs former disciple its only right I add a physics question so here it is... A particle moves along a straight line such that its position x(t)x(t) at time t (in seconds) is given by: Find the time when the particle is at rest.',
                        background: 'images/Math.png',
                        choices: [
                        {text: 't=5', nextScene: 'ALTENDING'},
                        {text: 't=2.', nextScene: 'AltChoices11'},
                        {text: 't=9', nextScene: 'ALTENDING'},
                        {text: 't=7', nextScene: 'ALTENDING'},
                        ]
                    },
                    AltChoices11: {
                        text: 'As promised you shall be freed, The Lorax and her gang thanks you...',
                        video: 'images/Dance.mp4',
                        choices: [
                        {text: 'True Ending', nextScene: 'start'},
                        ]
                    },
};
